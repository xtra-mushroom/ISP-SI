...
<head>
	...
	<title>login | SI Data KARYAWAN INDIHOME</title>
		...
		<div class="card">
			<div class="card-body login-card-body">
				<div class="login-logo">
					<a href="login.php">
						<font color="black">
							<b>SI DATA KARYAWAN INDIHOME</b>
						</font>
					</a>
				</div>
				<center>
					<img src="dist/img/indihome.png" width=180px />
					<br>
					<br>
				</center>
	...
	if ($jumlah_login == 1) {
		...
		echo "<script>
			Swal.fire({title: 'Login Berhasil',text: '',icon: 'success',confirmButtonText: 'OK'
				...
				{window.location = 'index.php?page=".$data_login["level"]."';}
			})</script>";
	} else {
		echo "<script>

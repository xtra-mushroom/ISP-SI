<div class="card card-info">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-table"></i> Data Teknisi Pemasangan</h3>
	</div>
	<!-- /.card-header -->
	<div class="card-body">
		<div class="table-responsive">
			<table id="example1" class="table table-bordered table-striped">
				...
				<?php
              	$no = 1;
			  	$sql = $koneksi->query("SELECT * from tb_karyawan WHERE posisi='Teknisi Pemasangan'");
            	...
            	?>
					<tr align="center">
						...
						<td>
							<?php echo $data['nomor_hp_karyawan']; ?>
						</td>
					</tr>
				<?php
              	}

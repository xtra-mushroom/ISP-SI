		...
		<div class="card card-info">
			...
			<div class="card-body p-0">
				<table class="table">
					<tbody>
						...
						<tr>
							...
							<td>:
								<?php echo tgl_indo($data_cek['tanggal_keluhan']); ?>
							</td>
						</tr>
						<tr>
							<td>
						...
						<tr>
							...
							<td>:
								<?php echo tgl_indo($data_cek['tanggal_perbaikan']); ?>
							</td>
						</tr>
				...
				<div class="card-footer float-right">
					<a href="?page=data-perbaikan" class="btn btn-warning">Kembali</a>

					<a href="./report/cetak_perbaikan.php?id=<?php echo $idPerbaikan; ?>" target=" _blank"

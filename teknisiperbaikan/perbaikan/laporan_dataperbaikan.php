<div class="card card-info">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-table"></i> Laporan Hasil perbaikan
		</h3>
	</div>
	...
	include "koneksi.php";
		...
		$query = "select tb_perbaikan.*, tb_pelanggan.id_pelanggan,  tb_pelanggan.namapelanggan,  tb_pelanggan.alamat from tb_perbaikan
		inner join  tb_pelanggan on tb_perbaikan.id_pelanggan =  tb_pelanggan.id_pelanggan";
		$url_cetak = "admin/perbaikan/cetak.php";
		$label = "( Data Hasil perbaikan )";
	...
	<div style="padding: 15px;">
		...
		<div>
			<h6 style="margin-left: auto;"><b>Laporan Hasil perbaikan</b>
				<?php echo $label ?>
			</h6>
